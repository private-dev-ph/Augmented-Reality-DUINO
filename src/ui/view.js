...
export function createView() {
  ...
  return {
    ...
    helpControl: document.querySelector('.help-control'),
    helpTooltip: byId('hint'),
    helpTooltipText: byId('hintText'),
    ...
    arCalibrationButton: byId('arCalibrationBtn'),
    arCameraVideo: byId('arCameraVideo'),
    arOverlayCanvas: byId('arOverlayCanvas'),
    arDebugCanvas: byId('arDebugCanvas'),
    arCalibrationOverlay: byId('arCalibrationOverlay'),
    arCalibrationGuide: byId('arCalibrationGuide'),
    arCalibrationLoupe: byId('arCalibrationLoupe'),
    arCalibrationLoupeCanvas: byId('arCalibrationLoupeCanvas'),
    arCalibrationDetectEdgeButton: byId('arCalibrationDetectEdgeBtn'),
    arCalibrationApplyButton: byId('arCalibrationApplyBtn'),
    arCalibrationPreviewButton: byId('arCalibrationPreviewBtn'),
    arCalibrationCancelButton: byId('arCalibrationCancelBtn'),
    devSettingsButton: byId('devSettingsBtn'),
    devSettingsWindow: byId('devSettingsWindow'),
    devTrackingMethod: byId('devTrackingMethod'),
    devShowTrackingFeatures: byId('devShowTrackingFeatures'),
    devIsolateSequence: byId('devIsolateSequence'),
    devTrackingDiagnostics: byId('devTrackingDiagnostics'),
    devTrackingMetrics: byId('devTrackingMetrics'),
    devDownloadTrackingLog: byId('devDownloadTrackingLog'),
    devClearTrackingLog: byId('devClearTrackingLog'),
    ...
    sequenceArTransparencyControl: byId('sequenceArTransparencyControl'),
    sequenceArTransparencyRange: byId('sequenceArTransparencyRange'),
    sequenceArTransparencyValue: byId('sequenceArTransparencyValue'),
